				...
				<div class="col-12">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Form Ubah Data Warga</h3>
						</div>
						<!-- /.card-header -->
						<!-- form start -->
						<form class="form-horizontal" method="post" action="<?=base_url('warga/update')?>">
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control datepicker" id="tanggal_lahir" name="tanggal_lahir" placeholder="Tanggal Lahir"  value="<?=$data['tanggal_asli']?>">
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<textarea name="alamat" id="alamat" class="form-control" placeholder="Alamat"><?=$data['alamat']?></textarea>
									</div>
								</div>
								<div class="form-group row">
